...
const Home = () => {
  ...
  const styles = `
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
    ...
    .user-actions { display: flex; gap: 12px; flex-wrap: wrap; align-items: center; }
    ...
    .client-avatar { width: 48px; height: 48px; background: linear-gradient(135deg, #fed7aa 0%, #fdba74 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #c2410c; font-weight: 700; font-size: 1.3rem; flex-shrink: 0; }
    ...
    .view-btn { background: #f97316; color: white; border: none; border-radius: 12px; padding: 8px 14px; font-weight: 600; cursor: pointer; font-size: 0.9rem; transition: 0.2s; }
    .view-btn:hover { background: #ea580c; }
    ...
    .dash-card { background: linear-gradient(135deg, #6d28d9 0%, #4c1d95 100%); border-radius: 24px; padding: 22px; color: white; cursor: pointer; box-shadow: 0 8px 28px rgba(109,40,217,0.35); transition: transform 0.2s, box-shadow 0.2s; position: relative; overflow: hidden; }
    .dash-card:hover { transform: translateY(-3px); box-shadow: 0 12px 36px rgba(109,40,217,0.45); }
    .dash-card-glow { position: absolute; top: -30px; right: -30px; width: 120px; height: 120px; background: rgba(255,255,255,0.07); border-radius: 50%; }
    .dash-card-glow2 { position: absolute; bottom: -20px; left: 20px; width: 80px; height: 80px; background: rgba(255,255,255,0.05); border-radius: 50%; }
    ...
    .city-filter-active { font-size: 0.9rem; color: #6b7280; margin-bottom: 16px; }
    ...
    @media (max-width: 1024px) { .main-grid { grid-template-columns: 1fr; padding: 24px 20px 40px; } }
    @media (max-width: 680px) { .user-header { padding: 16px 20px; flex-direction: column; align-items: flex-start; } }
  `;
      ...
      <div className="home-container">
        <div className="user-header">
          ...
          <div className="user-actions">
            ...
            <div
              ...
              title={`Você iniciou ${dailyContacts.current} de ${dailyContacts.max === 999 ? '∞' : dailyContacts.max} contatos hoje`}
            >
        ...
        <div className="main-grid">
              ...
              {carregando ? (
                ...
                servicosDisponiveis.map((servico) => (
                  ...
                  >
                    <div className="card-header">
                      <div className="client-info">
                        <div className="client-avatar">
                          {(servico.cliente_nome || 'C').charAt(0).toUpperCase()}
                        </div>
                        <div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            fontSize: '1.4rem',
                            color: favoritos.includes(servico.id) ? '#ef4444' : '#cbd5e1',
                    ...
                    <div className="service-name">{servico.titulo || servico.nome}</div>
                    {servico.descricao && (
                    ...
                    <div className="service-footer">
                      ...
                      <button
                        className="view-btn"
                        onClick={(e) => { e.stopPropagation(); handleCardClick(servico); }}
                      >
                        Ver detalhes <i className="fas fa-arrow-right" style={{ marginLeft: 4 }}></i>
                      </button>
                    </div>
                  </div>
                ))
          ...
          <div className="announcements-section">
            <div className="section-title">
              <span><i className="fas fa-star"></i> Novidades para Você</span>
            </div>
